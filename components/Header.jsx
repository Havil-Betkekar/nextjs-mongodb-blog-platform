    ...
    <div className="py-5 px-5 md:px-12 lg:px-28">
      ...
      <div className="text-center my-8">
        ...
        <p className="mt-10 max-w-[740px] m-auto text-xs sm:text-base">
          ...
          suscipit neque obcaecati facere, exercitationem, perspiciatis optio
          possimus nisi illum pariatur quidem quod magnam est. Nobis sequi
          perferendis non mollitia excepturi?
        </p>
        <form
